    ...
    : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(620, 500))
{
    ...
    chartCt = new chartContent(PanelIncludeSizer, PanelInclude, com);
    notesCt = new notesContent(PanelIncludeSizer, PanelInclude);
    settingCt = new settingContent(PanelIncludeSizer, PanelInclude, com);
